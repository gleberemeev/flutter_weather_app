...
class CityRepositoryImpl extends DatabaseAccessor<WeatherAppDb> with _$CityRepositoryImplMixin implements CityRepository {
  CityRepositoryImpl(super.attachedDatabase);
